<?php
	...
	if(isset($_SESSION['vendor_userid']))
	{
        ...
        <?php
            ...
            if($do == "Manage")
            {
                $stmt = $con->prepare("SELECT * FROM menus m, menu_categories mc where mc.category_id = m.category_id AND m.restaurant_id = ?");
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="above-table clearfix" style="margin-bottom: 1rem!important;">
                            <a href="menus?do=Add" class="btn btn-success">
                        ...
                        <div class="search-container">
                            <div class="input-group search-bar">
                                <input type="text" id="search_input" class="form-control" placeholder="Search menus...">
                                                        ...
                                                        <ul class="list-inline m-0">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Edit">
                                                                <button class="btn btn-success btn-sm rounded-0">
                                                                    <a href="menus.?do=Edit&menu_id=<?php echo $menu['menu_id']; ?>" style="color: white;">
            ...
            elseif($do == 'Add')
            {
                ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" class="menu_form" action="menus?do=Add" enctype="multipart/form-data">
                                <div class="panel-X">
                ...
                if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_menu_form == 0)
                {
                    ...
                    try
                    {
                        $stmt = $con->prepare("insert into menus(menu_name,menu_description,menu_price,menu_image,category_id,restaurant_id) values(?,?,?,?,?,?) ");
                        $stmt->execute(array($menu_name,$menu_description,$menu_price,$image,$menu_category,$vendor_userid));
                ...
                if($menu_id)
                {
                    ...
                    if($count > 0)
                    {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" class="menu_form" action="menus?do=Edit&menu_id=<?php echo $menu['menu_id'] ?>" enctype="multipart/form-data">
                                    <div class="panel-X">
                                        <div class="panel-header-X">
                                            <div class="main-title">
                                                <?php echo $menu['menu_name']; ?>
...
function searchMenus() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            // Re-initialize delete buttons after search
            $('.delete_menu_bttn').click(function() {
                var menu_id = $(this).data('id');
                var do_ = "Delete";
