<?php
    ...
    //Updated authentication check to match dashboard.php
...
<div class="card-body">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            ...
            <button class="btn btn-success btn-sm" type="button" data-toggle="modal" data-target="#add_new_category" data-placement="top">
    ...
    <div class="search-container">
        <div class="input-group search-bar">
            <input type="text" id="search_input" class="form-control" placeholder="Search by ID or name...">
...
$.ajax(
{
url:"ajax_files/menu_categories_ajax",
method:"POST",
...
success: function (data) 
{
    ...
    if(data['alert'] == "Success")
    {
        swal("New Category",data['message'], "success").then((value) => {
            window.location.replace("menu_categories");
        });
    }
...
url: "ajax_files/menu_categories_ajax",
method: "POST",
data: {search_value: searchValue, do: "Search"},
success: function(data) {
$('#categories_tbody').html(data);
